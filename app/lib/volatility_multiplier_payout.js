// This Javascript file contains the function to correctly output how much money should be paid to the client at any time for ALL Volatility indices
...
function vol_curr_payoff(
  ...
  var comm, payoff;
  comm = Math.max(0.02, 0.00003 * multiplier * stake);
