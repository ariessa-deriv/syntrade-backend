...
job = scheduler.add_job(random_walk, 'interval', seconds=1, misfire_grace_time=None)
scheduler.start()

if __name__ == '__main__':
    # Development
    socketio.run(app, port=int(os.getenv('FLASK_PORT')), host=os.getenv('FLASK_HOST'), debug=True)
